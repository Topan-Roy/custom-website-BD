                ...
                <div className="flex-1 bg-white rounded-xl p-6 shadow-lg ml-6 flex flex-col">
                    ...
                    <div className="mt-6 flex items-center justify-center">
                        <div className="relative w-full max-w-4xl"> {/* WIDTH BIGGER */}
                            ...
                            <button className="absolute -right-10 top-1/2 -translate-y-1/2 bg-white shadow-md w-10 h-10 rounded-full flex items-center justify-center cursor-pointertext-purple-600 text-xl">
